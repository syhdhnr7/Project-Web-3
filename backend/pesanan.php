        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion" id="sidenavAccordion" style="background-image: linear-gradient(to top, #000080, #005DBC, #007BFF);">
                <div class="sb-sidenav-menu">
                    ...
                    <div class="nav">
                        <a class="btn nav-link text-black active" style="background-image: linear-gradient(to top, #CBEAFF, #00BFFF);" href="pesanan.php">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4" style="text-shadow: 1px 1px 1px #000000; color: #704DC1;"><strong>Daftar Pesanan</strong></h1>
                    <hr>
                    <div class="card-body">
                                ...
                                ?>
                                    <tr style="background-color: #E6E6FA;">
                                        ...
                                        <td class="text-center">
                                            <a class="btn text-white mr-2" style="background-image: linear-gradient(to right, #704DC1, #9370DB, #C798FE); box-shadow: 3px 3px 3px #483D8B;" href="view_pesanan.php?id=<?= $row['id'] ?>">
                                                <i class="fas fa-fw fa-eye"></i> View</a>
                                            <a class="btn text-white mr-2" style="background-image: linear-gradient(to right, #704DC1, #9370DB, #C798FE); box-shadow: 3px 3px 3px #483D8B;" href="edit_pesanan.php?idedit=<?= $row['id'] ?>">
                                                <i class="fas fa-fw fa-edit"></i> Edit</a>
                                            <a class="btn text-white" style="background-image: linear-gradient(to right, #704DC1, #9370DB, #C798FE); box-shadow: 3px 3px 3px #483D8B;" href="delete_pesanan.php?iddel=<?= $row['id'] ?>">
